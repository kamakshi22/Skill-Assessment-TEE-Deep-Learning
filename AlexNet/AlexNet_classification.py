...
filewriter_path = "./logs/Classification"
checkpoint_path = "./checkpoints/Classification/"
...
with tf.Session() as sess:
    ...
    if(TRAINING==1):
        ...
        saver.restore(sess, "./checkpoints/Classification/model_epoch20.ckpt")
