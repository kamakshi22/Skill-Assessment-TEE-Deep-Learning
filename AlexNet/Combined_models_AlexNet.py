...
def Regression_criteria_percentage():
    ...
    with tf.Session() as sess:
        ...
        image_bt, label_bt = getImageLabel("../test_Labels366_new.csv", Name= "Criteria_Per",DATA_FOLDER=DATA_FOLDER)
...
def Regression_Gen_Expressions():
    ...
    with tf.Session() as sess:
        ...
        image_bt, label_bt = getImageLabel("../test_Labels366_new.csv",Name= "Gen_Impression",DATA_FOLDER=DATA_FOLDER)
...
def Classification():
    ...
    with tf.Session() as sess:
        ...
        DATA_FOLDER ="../original_data_frames"
        image_bt, label_bt = getImageLabel("../test_Labels366_new.csv", Name="Class_Category",DATA_FOLDER= DATA_FOLDER )
...
test= pd.read_csv("../test_Labels366_new.csv")
l = len(test)
predicted= pd.DataFrame()
predicted["Select_id"]= test["Select_id"]
predicted["Class"]= test["Class"]
predicted["Predicted_Class"]=Alexnet["Class"]
