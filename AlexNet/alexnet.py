...
class AlexNet(object):
  ...
  def load_initial_weights(self, session):
    ...
    #
    # orgConv1Wt = weights_dict[u'conv1'][0];
    # newConv1Wt = np.zeros([11,11,4,96]);
    # newConv1Wt[:,:,0,:] = orgConv1Wt[:,:,0,:];
    # newConv1Wt[:,:,1,:] = orgConv1Wt[:,:,1,:];
    # newConv1Wt[:,:,2,:] = orgConv1Wt[:,:,2,:];
    # newConv1Wt[:,:,3,:] = orgConv1Wt[:,:,0,:];
    # weights_dict[u'conv1'][0] = np.copy(newConv1Wt);
