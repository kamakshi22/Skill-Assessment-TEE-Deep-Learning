...
def Regression_criteria_percentage():
    ...
    with tf.Session() as sess:
        ...
        image_bt, label_bt = getImageLabel("../test_6people.csv", Name= "Criteria_Per")
...
def Regression_Gen_Expressions():
    ...
    with tf.Session() as sess:
        ...
        image_bt, label_bt = getImageLabel("../test_6people.csv",Name= "Gen_Impression")
...
test= pd.read_csv("../test_6people.csv")
l = len(test)
