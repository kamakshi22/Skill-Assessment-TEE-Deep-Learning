...
if selectedType == '1':
    filewriter_path = './logs/Gen_Impressions_original_data_frames'
    checkpoint_path = './checkpoints/Gen_Impressions_original_data_frames'
    OUTPUT_NAME = 'original_data_frames'
    DATA_FOLDER = '../original_data_frames'

elif selectedType == '2':
    filewriter_path = './logs/Gen_Impressions_canny_data_frames'
    checkpoint_path = './checkpoints/Gen_Impressions_canny_data_frames'
    OUTPUT_NAME = 'canny_data_frames'
    DATA_FOLDER = '../canny_data_frames'
    
elif selectedType == '3':
    filewriter_path = './logs/Gen_Impressions_enhanced_data_frames'
    checkpoint_path = './checkpoints/Gen_Impressions_enhanced_data_frames'    
    OUTPUT_NAME = 'enhanced_data_frames'
    DATA_FOLDER = '../enhanced_data_frames'

elif selectedType == '4':
    filewriter_path = './logs/Gen_Impressions_segmentation_data_frames'
    checkpoint_path = './checkpoints/Gen_Impressions_segmentation_data_frames'
    OUTPUT_NAME = 'segmentation_data_frames'
    DATA_FOLDER = '../segmentation_data_frames'

elif selectedType == '5':
    filewriter_path = './logs/Gen_Impressions_segmentation_contour_data_frames'
    checkpoint_path= './checkpoints/Gen_Impressions_segmentation_contour_data_frames'
...
def getImageLabel(path):
    ...
    Img_Path, Class_Category, Criteria_Avg, Criteria_Per, Label = tf.decode_csv(value,
...
with tf.Session() as sess:
    ...
    if(TRAINING==1):
        ...
        image_bt, label_bt = getImageLabel("../test_6people_copy.csv")
        ...
        saver.restore(sess,  checkpoint_path+"/model_epoch60.ckpt")
